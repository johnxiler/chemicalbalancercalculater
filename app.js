...
function demo(formulaStr, index) {
  document.getElementById("inputFormula").value = formulaStr;
  balance(formulaStr);
  document.getElementById("inputFormula").value = "";

  // Display the equation in the new div
  document.getElementById("equationDisplay").innerText = formulaStr;

  // Make the div clickable
  document.getElementById("equationDisplay").addEventListener("click", function () {
    document.getElementById("inputFormula").value = formulaStr;
    balance(formulaStr);
  });
}
